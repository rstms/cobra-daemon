...
update:
	...
	@curl -s -L -o common/common.go https://raw.githubusercontent.com/rstms/go-common/master/proxy_common_go
	@sed -i -e 's/package cmd/package common/' common/common.go
